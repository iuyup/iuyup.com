      ...
      >
        <div className="max-w-3xl mx-auto px-6">
            ...
            {[
              {
                ...
                slug: "building-agent-flow",
              },
              {
                title: "知乎掘金 | Claude Managed Agents 深度解读",
                date: "2026-04-05",
                summary: "深入分析 Claude 的 Managed Agents 架构，探讨其在复杂任务处理中的优势与局限性。",
                tags: ["Claude", "AI Agent"],
                slug: "知乎掘金_Claude_Managed_Agents深度解读",
              },
            ].map((post, i) => (
              <motion.div
                key={post.slug}
          ...
          <div className="mt-8">
            <Link
              href="/posts"
              className="text-sm text-[#6B8DAE] hover:underline transition-colors"
            >
              查看全部博客 →
            </Link>
          </div>
